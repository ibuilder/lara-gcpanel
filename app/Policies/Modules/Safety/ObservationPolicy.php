...
class ObservationPolicy
{
    ...
    {
        return $user->hasPermissionTo('view observations');
    }
     ...
     *
     * @param  \App\Models\User  $user
     * @param  \App\Models\Modules\Safety\Observation  $observation
     * @return \Illuminate\Auth\Access\Response|bool
     */
    ...
    {
        return $user->hasPermissionTo('create observations');
    }
    ...
    {
        return $user->hasPermissionTo('edit observations');
    }
    ...
    {
        return $user->hasPermissionTo('delete observations');
    }
