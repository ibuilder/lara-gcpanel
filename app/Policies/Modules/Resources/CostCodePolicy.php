...
use App\Models\Modules\Resources\CostCode;
use App\Models\User;
...
class CostCodePolicy
{
    ...
    {
        return $user->hasPermissionTo('view costcodes');
    }
     ...
     *
     * @param  \App\Models\User  $user
     * @param  \App\Models\Modules\Resources\CostCode  $costCode
     * @return \Illuminate\Auth\Access\Response|bool
     */
    ...
    {
        return $user->hasPermissionTo('create costcodes');
    }
    ...
    {
        return $user->hasPermissionTo('edit costcodes');
    }
    ...
    {
        return $user->hasPermissionTo('delete costcodes');
    }
