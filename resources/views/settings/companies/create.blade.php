<!-- filepath: resources/views/settings/companies/create.blade.php -->
<x-app-layout>
    <x-slot name="header">
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form method="POST" action="{{ route('settings.company_management.store') }}">
                        @csrf
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="website" class="block mt-1 w-full" type="url" name="website" :value="old('website')" placeholder="https://example.com" autocomplete="url" />
